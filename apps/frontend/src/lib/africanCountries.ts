/** African markets — ISO 3166-1 alpha-2 + default ISO 4217 currency per country */
...
const EXTRA = ["USD", "EUR", "GBP"] as const;

export const ISO_CURRENCIES = Array.from(
  new Set([...AFRICAN_COUNTRIES.map((c) => c.currency), ...EXTRA]),
).sort();
